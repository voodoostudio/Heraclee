...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'Villa_Gaiadata/Villa_Gaia_messages_','.xml');
	krpanoLoaded = true;
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'Villa_Gaiadata/Villa_Gaia_messages_','.xml');
}
...
function addKolorBox(pPlugID)
{
	...
	{
		var kolorBoxCSS = new ktools.CssStyle("KolorBoxCSS", crossDomainTargetUrl+"Villa_Gaiadata/graphics/KolorBox/kolorBox.css");
		var kolorBoxJS = new ktools.Script("KolorBoxJS", crossDomainTargetUrl+"Villa_Gaiadata/graphics/KolorBox/KolorBox.min.js", [], true);
