                                ...
                                <div class="inner_block_container">
                                    ...
                                    <div class="article_info_block">
                                        <div class="article_img">
                                            <a href="{{ URL::to($lang . '/admin/newsletter/' . $items->id) }}">
                                                @php
                                                    $image_counter = 1;
                                                @endphp
                                        ...
                                        <div class="article_info">
                                            <a href="{{ URL::to($lang . '/admin/newsletter/' . $items->id) }}"><h2>@if($lang == 'fr') {{ $items['title_fr'] }} @elseif($lang == 'en') {{ $items['title_en'] }}  @endif</h2></a>
