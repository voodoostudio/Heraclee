                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-4 col-xl-3 margin_bottom_10">
                                ...
                                <select id="view_select" name="object_view" title="">
                                    <option value="" {{ (!empty($_POST['object_view'])) ? 'selected' : '' }}>{{ trans('lang.choose_view') }}</option>
                            ...
                            <div class="col-12 col-sm-6 col-md-4 col-xl-3 margin_bottom_10">
                                ...
                                <select id="standing_select" name="object_standing" title="">
                                    <option value="" {{ (!empty($_POST['object_standing'])) ? 'selected' : '' }}>{{ trans('lang.choose_standing') }}</option>
