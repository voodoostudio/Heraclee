            ...
            <div class="info_block">
                <div class="title_container">
                    ...
                    <ul class="social_networks">
                        ...
                        <li><a class="fb-share-button" onclick="window.open($(this).attr('href'), 'Facebook', config='height=100, width=400, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no'); return false;" href="https://www.facebook.com/dialog/feed?app_id=1820110634732413&display=popup&caption={{$property['comments']['comment']}}&link={{ Request::fullUrl() }}&redirect_uri=https://developers.facebook.com/tools/explorer"><i class="icn icon-facebook"></i></a></li>
