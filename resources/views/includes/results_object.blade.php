            ...
            <div class="info_block">
                <div class="title_container">
                    ...
                    <ul class="social_networks">
                        ...
                        <li><a class="fb-share-button" onclick="window.open($(this).attr('href'), 'Facebook', config='height=100, width=400, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no'); return false;" href="https://www.facebook.com/dialog/feed?app_id=1820110634732413&ref=site&display=popup&name=Test&caption={{$property['comments']['comment']}}&description={{$property['comments']['comment']}}&picture=https://s3-eu-west-1.amazonaws.com/apimo/pictures/estate/1776/1775694/1515759126593e6b3109ac19.04618175_941871a3da_1024.jpg&link=@if(($property['category']['reference'] == 1) || ($property['category']['reference'] == 4) || ($property['category']['reference'] == 5) || ($property['category']['reference'] == 6)){{ route('details') }}?id={{$property['property_id']}} @elseif(($property['category']['reference'] == 2) || ($property['category']['reference'] == 3)) {{ route('locationsDetails') }}?id={{$property['property_id']}} @endif"><i class="icn icon-facebook"></i></a></li>
