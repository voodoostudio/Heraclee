            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable">
                <tr>
                    <td align="center" valign="top" id="bodyCell">
                        <!-- BEGIN TEMPLATE // -->
						<!--[if (gte mso 9)|(IE)]>
						<table align="center" border="0" cellspacing="0" cellpadding="0" width="600" style="width:600px; margin: 0 auto">
						<tr>
                            ...
                            <tbody class="mcnDividerBlockOuter">
                                <tr>
                                    <td class="mcnDividerBlockInner" style="min-width: 100%; padding: 55px 18px 15px;">
...
-->
    ...
    <tbody class="mcnButtonBlockOuter">
        <tr>
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border: 2px solid #FFFFFF;border-radius: 0px;">
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 18px; padding: 15px;">
                                <a class="mcnButton " title="www.heraclee.com" href="http://heraclee.com/fr" target="_blank" style="font-weight: bold;letter-spacing: 2px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">www.heraclee.com</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <tbody class="mcnDividerBlockOuter">
        <tr>
            <td class="mcnDividerBlockInner" style="min-width: 100%; padding: 15px 18px 35px;">
                <table class="mcnDividerContent" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width: 100%;border-top: 1px solid #CBAC85;">
                    <tbody><tr>
                        <td>
                            <span></span>
...
<table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnCaptionBottomContent" width="282">
    <tbody><tr>
        <td class="mcnCaptionBottomImageContent" align="center" valign="top" style="padding:0 9px 9px 9px;">
            ...
            <img alt="" src="https://gallery.mailchimp.com/09344a9c16649b0da5dc09c38/images/4ef05f55-da6d-4e6b-a123-f56e80862316.png" width="109" style="max-width:109px;" class="mcnImage">
            
        
        </td>
    </tr>
    <tr>
        <td class="mcnTextContent" valign="top" style="padding: 0px 9px;color: #CBAC85;font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;font-size: 16px;text-align: center;" width="264">
            <span style="font-family:open sans,helvetica neue,helvetica,arial,sans-serif"><a href="" style="color: #cbac85!important; text-align: left; text-decoration: none;">Saint-Tropez 44, Route des Plages 83990 Saint-Tropez&nbsp;</a><br>
<span>+</span><span>33</span> <span>(0)4­ 94 54 20 01</span></span>
        </td>
    </tr>
</tbody></table>
...
<table align="right" border="0" cellpadding="0" cellspacing="0" class="mcnCaptionBottomContent" width="282">
    <tbody><tr>
        <td class="mcnCaptionBottomImageContent" align="center" valign="top" style="padding:0 9px 9px 9px;">
            ...
            <img alt="" src="https://gallery.mailchimp.com/09344a9c16649b0da5dc09c38/images/6619e6a7-ffdb-409f-85ef-fcc9239197af.png" width="148" style="max-width:148px;" class="mcnImage">
    ...
    <tr>
        <td class="mcnTextContent" valign="top" style="padding: 0px 9px;color: #CBAC85;font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;font-size: 16px;text-align: center;" width="264">
            <span style="font-family:open sans,helvetica neue,helvetica,arial,sans-serif"><a href="" style="color: #cbac85!important; text-align: left;  text-decoration: none;">La Croix-Valmer Rdpt. du Débarquement 83420 La Croix Valmer</a>&nbsp;<a href="" style="color: #cbac85!important; text-decoration: none;"><span>+</span><span>33</span> <span>(0)</span><span>4­ 98 12 94 12</span></a></span><br>
<br>
&nbsp;
        </td>
    </tr>
...
-->
    ...
    <tbody><tr>
        <td align="center" style="padding-left:9px;padding-right:9px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width: 100%;background-color: #272727;" class="mcnFollowContent">
                <tbody><tr>
                                            ...
                                            <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnFollowStacked" style="display:inline;">
                                                ...
                                                <tbody><tr>
                                                    <td align="center" valign="top" class="mcnFollowIconContent" style="padding-right:10px; padding-bottom:9px;">
                                                        <a href="https://www.facebook.com/pg/heraclee.immobilier.saint.tropez/about/" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/outline-light-facebook-96.png" alt="Facebook" class="mcnFollowBlockIcon" width="48" style="width:48px; max-width:48px; display:block;"></a>
                                                    </td>
                                                </tr>
                                            ...
                                            <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnFollowStacked" style="display:inline;">
                                                ...
                                                <tbody><tr>
                                                    <td align="center" valign="top" class="mcnFollowIconContent" style="padding-right:0; padding-bottom:9px;">
                                                        <a href="http://instagram.com/heracleesainttropez" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/outline-light-instagram-96.png" alt="Instagram" class="mcnFollowBlockIcon" width="48" style="width:48px; max-width:48px; display:block;"></a>
                                                    </td>
                                                </tr>
            ...
            <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #CBAC85;font-size: 14px;text-align: center;">
                        
                            © 2017 - HERACLEE - Tous droits reservés
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
